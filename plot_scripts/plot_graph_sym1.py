...
for i in range(frame):
    ...
    for obstacle in obstacles:
            ...
            oby = obstacle[1]
            obz = obstacle[2]
            # ax.plot_surface((cube_x+obx)*10,(cube_y+oby)*10,(cube_z+obz)*10, color='b', rstride = 1, cstride =1)
    ...
    plt.savefig('/home/robolab/plot_result/cbf_cvt/sym1/' + "{:09d}".format(i) + '.png')
